<p align="center"><img src="../resource/Molten.logo.png" alt="Molten logo" width="61.8%" style="margin-bottom:-4em;"/></p>
<h1 align="center" style="font-size:3.5rem;margin-top:-0.3em;">Molten</h1>
...
```molten
Human.Male, Earth.Location.America,
[Human.Male, Earth.Location.America] (American.Citizen.Male)
```

Would evaluate on the first iteration to American.Citzen.Male. Note that since `Human.Male, Earth.Location.America` is in the root context, it would emit once per evaluation, so this function is an _infinite generator_ of the `American.Citzen.Male` graph.
