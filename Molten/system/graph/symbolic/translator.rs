...
pub mod traits {
    ...
    pub trait Translatable: Read + Seek {}

    impl<Template> Translatable for Template where Template: Read + Seek {}
}
...
impl<Source: traits::Translatable> Translator<Source, u8> for Source {
    fn view(
        &mut self,
        filter: &Rule<u8>,
        terminator: &Rule<u8>,
