...
impl Error {
    ...
    /// Create a beautiful template validation error with source code context
    pub fn template(
        path: &str,
        content: String,
        function: SourceSpan,
    ...
    /// Create a beautiful cases validation error with source code context
    ...
    /// Create a missing parameter validation error with JSON context
    pub fn missing(
        path: &str,
        content: String,
    ...
    /// Create an extra parameter validation error with JSON context
    pub fn extraneous(
        path: &str,
        content: String,
        problem: Option<(usize, usize)>,
    ...
    /// Create a test case validation error with JSON context
    pub fn test(
        case: &str,
        content: String,
