...
load(":autotest.bzl", _autotest_document = "autotest_document", _autotest_document_performance = "autotest_document_performance", _autotest_function = "autotest_function", _autotest_performance = "autotest_performance", _autotest_template = "autotest_template", _rust_autotest_function = "rust_autotest_function", _rust_autotest_performance = "rust_autotest_performance", _rust_autotest_template = "rust_autotest_template")
...
autotest_document_performance = _autotest_document_performance
